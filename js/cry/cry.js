...
function crystalCut(qzOri){
   ...
   for (let zn = 0; zn < 2;zn++){ //qzOri.geometry.nmbZones_n; zn++){
      fgZn=true;        
...
//console.log(zn + " zn pl " + qzCut.geometry.zone_n[zn].nmbPlanes );
...
//console.log(i + " pl ln " +qzCut.geometry.pl_n[pNm].pLine);         
//console.log(i + " pl ln " + qzCut.geometry.pl_n[pNm].nmbLines);         
  ...
  // for( let p =0 ; p<polyQq.geometry.pl_n.length;p++)
  //console.log(p +" ccc  " + polyQq.geometry.pl_n[p].pPolygon)

...
function sceneIntro( sceneIntro,  qrz = null){
  ...
  if(qrz != null){
   ...
   structuteGroup = cellAlphaBeta(cellType,0);
   structuteGroup.position.copy(scnIntroCenter);
   structuteGroup.position.x += 1.5;
   structuteGroup.position.z += 1.0;
   structuteGroup.scale.set(.2,.2,.2);
   sceneIntro.add(structuteGroup);

   tetraGroup = cellAlphaBeta(tetraType,0);
   ...
   bulkGroup = cellAlphaBeta(bulkType,0);
